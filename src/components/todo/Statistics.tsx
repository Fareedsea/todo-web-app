...
export default function Statistics({ stats, onClearCompleted }: StatisticsProps) {
      ...
      <div className="space-y-4">
        ...
        {stats.completed > 0 && (
          <button
            ...
            className="w-full mt-4 px-4 py-2 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-lg font-medium transition-colors"
          >
